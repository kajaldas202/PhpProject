        ...
        <div class="container-xxl py-5">
            <div class="container">
                <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px;">
                    ...
                    <p>"Preschool is the first experience that helps children step out of their comfort zone."</p>
                </div>
                <div class="owl-carousel testimonial-carousel wow fadeInUp" data-wow-delay="0.1s">
                    <div class="testimonial-item bg-light rounded p-5">
                        <p class="fs-5">"The care and attention our child receives at kider Preschool.
                             The teachers are incredibly nurturing and create a fun, engaging learning environment.
                              Our child looks forward to going to schoolregular!"</p>
                        <div class="d-flex align-items-center bg-white me-n5" style="border-radius: 50px 0 0 50px;">
                            <img class="img-fluid flex-shrink-0 rounded-circle"  src="img\cropped_image (14).png"  style="width: 90px; height: 90px;">
                            <div class="ps-3">
                                <h3 class="mb-1">Ishaan-parents</h3>
                            </div>
                            <i class="fa fa-quote-right fa-3x text-primary ms-auto d-none d-sm-flex"></i>
                        </div>
                    </div>
                    <div class="testimonial-item bg-light rounded p-5">
                        <p class="fs-5">"The curriculum at kider Preschool is fantastic! Our daughter has learned so much and always comes home excited to share what she's done in class.The kids are happy and safe."</p>
                        <div class="d-flex align-items-center bg-white me-n5" style="border-radius: 50px 0 0 50px;">
                            <img class="img-fluid flex-shrink-0 rounded-circle" src="img\cropped_image (13).png" style="width: 90px; height: 90px;">
                            <div class="ps-3">
                                <h3 class="mb-1">Aisha-parents</h3>
                            </div>
                            <i class="fa fa-quote-right fa-3x text-primary ms-auto d-none d-sm-flex"></i>
                        </div>
                    </div>
                    <div class="testimonial-item bg-light rounded p-5">
                        <p class="fs-5">"As first-time parents, sending our child to Little Stars Preschool was a big decision for us. Thank you to the dedicated staff for making our child's preschool experience unforgettable."</p>
                        <div class="d-flex align-items-center bg-white me-n5" style="border-radius: 50px 0 0 50px;">
                            <img class="img-fluid flex-shrink-0 rounded-circle"  src="https://images.shiksha.com/mediadata/images/articles/1681537335phpsK1FNx.jpeg" style="width: 90px; height: 90px;">
                            <div class="ps-3">
                                <h3 class="mb-1">Kiara-parents</h3>
                            </div>
                            <i class="fa fa-quote-right fa-3x text-primary ms-auto d-none d-sm-flex"></i>
                        </div>
                    </div>
