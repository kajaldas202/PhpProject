        ...
        <div class="container-xxl py-5">
            <div class="container">
                <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px;">
                    ...
                    <p>Popular teachers at our school are those who bring enthusiasm, creativity, and a deep care for their students to the classroom. Known for their engaging teaching methods, they make learning fun and accessible. </p>
                </div>
                <div class="row g-4">
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="team-item position-relative">
                            <img class="img-fluid rounded-circle w-75" src="https://img.freepik.com/premium-photo/portrait-indian-women-teacher-with-bindi-wearing-chudidhar-pashmina-classroom_95618-519.jpg" alt="">
                            <div class="team-text">
                                <h3>Radhika Verma</h3>
                    ...
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                        <div class="team-item position-relative"> 
                            <img class="img-fluid rounded-circle w-75" src="https://www.millerchevalier.com/sites/default/files/styles/wide/public/2023-10/BioPhoto_Patil_Aditi.png?itok=I8RKHmRt" alt="">
                            <div class="team-text">
                                <h3>Aditi Pal</h3>
                                <p>Art Teacher</p>
                                <div class="d-flex align-items-center">
                    ...
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                        <div class="team-item position-relative">
                            <img class="img-fluid rounded-circle w-75" src="https://img.freepik.com/premium-photo/portrait-indian-preschool-women-teacher-with-bindi-wearing-shirt-with-scarfs-classroom_95618-515.jpg" alt="">
                            <div class="team-text">
                                <h3>Niti shah</h3>
                                <p>Dance Teacher</p>
                                <div class="d-flex align-items-center">
